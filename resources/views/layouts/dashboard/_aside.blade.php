    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li><a href="{{ route('dashboard.welcome') }}"><i class="fa fa-dashboard"></i><span>@lang('site.dashboard')</span></a></li>
                ...
                <li><a href="{{ route('dashboard.products.index') }}"><i class="fa fa-edit"></i><span>@lang('site.products')</span></a></li>
         
                <li><a href="{{ route('dashboard.clients.index') }}"><i class="fa fa-users"></i><span>@lang('site.clients')</span></a></li>
           
                <li><a href="{{ route('dashboard.orders.index') }}"><i class="fa fa-cart-plus"></i><span>@lang('site.orders')</span></a></li>
