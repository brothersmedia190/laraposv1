                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($clients as $index=>$client)
                                <tr>
                                    ...
                                    <a href="{{ route('dashboard.clients.orders.create', $client->id) }}" class="btn btn-default btn-sm">@lang('site.add_order')</a>
                                        
                                    </td>
                                    <td>
                                     
                                    <a href="{{ route('dashboard.clients.edit', $client->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
